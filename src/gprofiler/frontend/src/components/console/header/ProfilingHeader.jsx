        ...
        <Box sx={{ background: COLORS.ALMOST_WHITE, position: 'relative' }}>
            ...
            <Flexbox
                ...
                <Button
                    ...
                    endIcon={<Icon name={filtersExpanded ? ICONS_NAMES.ChevronDown : ICONS_NAMES.ChevronRight} />}
                    sx={{
                        textTransform: 'none',
            ...
            <Collapse in={filtersExpanded} timeout='auto' unmountOnExit>
                <Flexbox spacing={{ xs: 1, sm: 2, md: 4 }} justifyContent='start' sx={{ p: 4, zIndex: 3 }}>
                    <Box
                        sx={{
                            display: 'grid',
                            gridTemplateColumns: {
                    ...
                    {/* Action Buttons */}
                    <Flexbox justifyContent='flex-end' gap={2} sx={{ mt: 2 }}>
                        <Button
                            variant='outlined'
                            size='medium'
